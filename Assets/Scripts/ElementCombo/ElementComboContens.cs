...
public class ElementComboContens : ScriptableObject
{
    ...
    [Tooltip("Spawns the projectile comparetly to the ainmation. 0 is the start of the animation, 1 is the end of the animation. Does nothing when animation is emtpy")]
    [Range(0, 1)] public float WhenToSpawn = 1f;
